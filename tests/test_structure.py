...
def test_orchestrator_files_exist():
    ...
    for file_name in required_files:
        file_path = base_dir / file_name
        assert file_path.exists(), f"Required file {file_name} not found in orchestrator/"
...
def test_integration_files_exist():
    ...
    for file_name in required_files:
        file_path = base_dir / file_name
        assert file_path.exists(), f"Required file {file_name} not found in integrations/"

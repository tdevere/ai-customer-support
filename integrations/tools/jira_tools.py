...
@tool
async def search_jira_tickets(query: str, max_results: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            return {
                ...
                "priority": data["fields"]["priority"].get("name") if data["fields"].get("priority") else None,
                "assignee": data["fields"]["assignee"].get("displayName") if data["fields"].get("assignee") else None,
